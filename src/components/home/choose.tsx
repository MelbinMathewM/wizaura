...
export default function HomeChoose() {
    const features = [
        {
            icon: <FaRocket size={24} className="text-indigo-500" />,
        ...
        {
            icon: <FaCheckCircle size={24} className="text-indigo-500" />,
            title: "Trustworthy",
            description: "We ensure clarity, honesty, and transparency for consistently excellent results.",
        },
        {
            icon: <FaClock size={24} className="text-indigo-500" />,
        ...
        >
            <div className="max-w-6xl mx-auto flex flex-col items-center gap-8">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-100 text-center">
                    Why Choose <span className="text-indigo-500">Wizaura</span>
                </h2>
                <p className="text-gray-600 dark:text-gray-300 text-center text-lg sm:text-xl max-w-2xl">
                    We blend <span className="text-indigo-500 font-semibold">creativity</span>,{" "}
                    <span className="text-indigo-500 font-semibold">expertise</span>, and{" "}
                    <span className="text-indigo-500 font-semibold">technology</span> to deliver solutions that empower your business.
                </p>
