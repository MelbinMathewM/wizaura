    ...
    const services = [
        {
            ...
            icon: <FaCogs className="text-cyan-500 w-8 h-8 mb-3" />,
        },
        {
        ...
        <section className="py-16 px-6 bg-white dark:bg-black transition-colors duration-500">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
                {services.map((service, index) => (
                    ...
                    >
                        {service.icon}
                        <h3 className="text-cyan-500 font-semibold text-xl mb-2">{service.title}</h3>
