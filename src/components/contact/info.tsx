...
export default function ContactInfo() {
    const info = [
        {
            icon: <FaPhoneAlt className="w-5 h-5 text-cyan-600 dark:text-cyan-400" />,
            title: "Phone",
            detail: "+91 97478 27371",
            href: "tel:+919747827371",
        },
        {
            icon: <FaEnvelope className="w-5 h-5 text-cyan-600 dark:text-cyan-400" />,
            title: "Email",
            detail: "info@wizaura.com",
            href: "mailto:info@wizaura.com",
        },
        {
            icon: <FaMapMarkerAlt className="w-5 h-5 text-cyan-600 dark:text-cyan-400" />,
            title: "Address",
