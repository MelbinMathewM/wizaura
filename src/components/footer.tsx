            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex gap-4 mt-2">
                        ...
                        <a href="https://www.instagram.com/wizaura.co/" className="text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition-colors duration-300"><FaInstagram /></a>
                    </div>
                </div>
            </div>
