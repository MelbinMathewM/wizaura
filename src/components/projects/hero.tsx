    ...
    return (
        <section className="relative w-full py-12 px-6 sm:px-12 lg:px-20 bg-white dark:bg-black transition-colors duration-500">
            <div className="max-w-6xl mx-auto flex flex-col items-center text-center gap-6">
                ...
                <Link href="/contact">
                    <span className="mt-3 inline-flex items-center bg-cyan-500 text-white font-semibold px-4 py-2 rounded-full shadow-lg hover:shadow-2xl hover:translate-y-0.5 hover:scale-105 transition-all duration-300">
                        Start Your Project
