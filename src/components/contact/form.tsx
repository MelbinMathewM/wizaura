    ...
    return (
        <section className="w-full py-12 px-6 sm:px-12 lg:px-20 bg-gray-50 dark:bg-gray-900 transition-colors duration-500">
            <div className="max-w-4xl mx-auto">
                <h2 className="text-2xl sm:text-3xl font-bold text-indigo-600 dark:text-indigo-400 mb-3 text-center">
                    Send Us a Message
                </h2>
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 sm:gap-6">
                        ...
                        <div>
                            <input
                                ...
                                className={`w-full px-4 py-3 rounded-lg border ${errors.name ? "border-red-500" : "border-gray-300 dark:border-gray-700"
                                    } bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500 outline-none transition`}
                            />
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="bg-indigo-600 dark:bg-indigo-600 text-white dark:text-gray-300 px-6 py-3 rounded-full font-semibold hover:bg-indigo-700 dark:hover:bg-indigo-600 transition flex justify-center items-center gap-2"
                    >
                        {isLoading ? (
                            <svg
